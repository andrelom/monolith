...
using Monolith.Core.Mvc.Internal.Swagger;
using Swashbuckle.AspNetCore.SwaggerGen;

namespace Monolith.Core.Mvc.Internal
{
    internal static class SwaggerGenOptionsExtensions
    {
        ...
        private static bool GetDocInclusionPredicate(string version, ApiDescription description)
        {
            ...
            return method.DeclaringType
                ...
                .Any(value => $"v{value}".Equals(version, StringComparison.InvariantCultureIgnoreCase));
        }
